...
** Note: Instructions are assuming a Windows operating system.
         For other OS, please adapt as needed.

=============
Pre-Execution
=============

This application was coded in Python version 2.7.8 release.

Your machine needs to have Python 2.7.8 installed, you can
get Python here at https://www.python.org/. Make sure to
download the 2.7.X version not the 3.X versions since wxPython
does not support the 3.X version of Python.
...
A 64 bit wxPython for Python 2.7 is required.
...
The application was developed in Eclipse with pyDev.
